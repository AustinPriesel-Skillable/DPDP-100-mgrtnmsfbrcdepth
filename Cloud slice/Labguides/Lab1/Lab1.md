...
1. Search for +++Synapse Analytics+++ and select **Azure Synapse Analytics.**
...
1. Enter below details to create resource group and then click on **OK**.
    ...
    1. **Resource Group**: @lab.CloudResourceGroup(ResourceGroup1).Name
    ...
    1. **Region**: @lab.CloudResourceGroup(ResourceGroup1).Location
        ...
        - Select **Data Lake Storage Gen2:** *(create a new Account and File System name)*
...
1. On the Synapse Workspace Overview page select **New Dedicated SQL Pool**.
...
1. Select **Go to Resource**, select **open** on the **Open Synapse Studio** tile.
...
1. Go to **Manage → SQL pools** and confirm the Dedicated SQL Pool shows **Online**
    ...
    >[!Note] A dedicated SQL pool consumes billable resources as long as it's active. You can pause the pool later to reduce costs. Please Pause it if you not performing labs for the day or even for 30 minutes to save your credits.

    Make sure to resume your SQLPool before you start your labs.

1. In the Overview section of the Synapse workspace home page, copy the **Dedicated SQL endpoint and Dedicated SQL pool**, and save them in a notepad.
...
1. Under the category **Azure Data Lake Storage Gen2** you'll see an item with your workspace name: **fabricsynapse@lab.LabInstance.Id (Primary)**
...
1. Select the container named **synapsefile (Primary)**.
...
1. Select **Upload** and browse ***NYCTripSmall.parquet*** from **C:\Labfiles** and then click on **Upload** button.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image28.png)
...
1. Repeat the same steps to upload the remaining **DimDate.csv, Dimension_Employee.csv** files
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image32.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image33.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image34.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image35.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image36.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image37.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image38.png)
...
1. Right click on it and then click on **NYCTripSmall.parquet** and select **Properties**.
...
1. In Properties page, copy URL and ABFSS path and save it in notepad to use them in further labs.
...
1. Under **Activities**, expand the **Move and transform** , and drag a **Copy data** object into the canvas.
...
1. On the **Source** page, select **+ New**
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image47.png)

1. In **New integration dataset**, select the **Azure Data Lake Storage Gen2** tile.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image48.png)

1. Select the **DelimitedText** tile and click **Continue**.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image49.png)

1. In **Set properties**, click **+ New** under **Linked service** to create a new connection to the storage account

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image50.png)

1. In **New linked service**, provide a name, select your **Azure subscription** and **Storage account**, then click **Test connection** and **Create** after a successful validation.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image51.png)

1. Browse and select the **folder**, then choose the required file.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image52.png)

1. Select the **DimDate.csv** file and click **OK**.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image53.png)

1. In the Synapse pipeline, the user selects the **Sink** tab within the Copy Data activity to configure the destination settings for the dataset.
...
1. In **New integration dataset**, select the **Azure Synapse Analytics** tile.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image56.png)

1. In the New Linked Service setup, the **Azure subscription, server name, and database name** fields are selected to configure the connection to the Synapse SQL dedicated pool
...
1. Enter User name as +++sqladmin+++ and password as +++password321!+++. Click **Test connection**. If successful, click **Continue**.
...
1. Select the **Auto create table** option in the Sink settings and then click on the **Mapping** tab to proceed.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image60.png)

1. Click **Import schemas** to automatically detect and load the file structure.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image61.png)

1. Click **Debug**.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image62.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image63.png)

1. Repeat the same steps as before, then click on the **Source** tab and select **Open** to view the source dataset configuration.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image64.png)

1. Click **Browse** folder.

1. Select the **Dimension_Employee.csv** file and click **OK**.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image66.png)

1. Click **Pipeline**

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image67.png)

1. Click on the **Sink** tab and then select **Open** to view the sink dataset configuration.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image68.png)

1. In the **sink** dataset configuration, enter the schema as +++dbo+++ and specify the table name as +++fabric_employee+++, then return to **Pipeline 1** to continue with the setup. 

	![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image69.png)

1. Click **Mapping**.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image70.png)

1. Click **Import schema**.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image71.png)

1. Click **Debug** to test and validate the pipeline execution.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image72.png)
...
1. **In Synapse Studio,** click on **Data hub.**
...
1. Make sure **files** deployed successfully

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image75.png)

## Task 5: Create a Fabric workspace

In this task, you set up a new Microsoft Fabric workspace to serve as the central hub for the Medallion Architecture implementation. This workspace brings together all essential components, including Lakehouses, Dataflows, Pipelines, Warehouses, Notebooks, and Power BI assets.
...
1. On the **Fabric Home** page click on **+ New Workspaces** as shown in the image below.
    ...
    | Field                   | Value                                                                 |
    |------------------------|-----------------------------------------------------------------------|
    | Name                   | +++Fabric-Migration@lab.LabInstance.Id+++ |
...
1. On the **Create a workspace** pane that appears to the right, enter the following details, and then click **Apply**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image77.png)
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image78.png)

1. The Workspace is now created.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image79.png)
...
1. In the **Migrate to Fabric** source menu, under **Migrate to Fabric**, select the **Azure Synapse Analytics dedicated SQL pool** tile.
...
1. Click **Choose file**
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image83.png)

1. Browse to **C:\LabFiles**, select the **AdventureWorks.DACPAC** file, and click **Open**.
...
1. When the upload is complete, select **Next**.
    ...
    - In the **Set the destination** page, enter the **Fabric workspace name** and specify a new warehouse item (e.g., +++Migration_Warehouse+++) as the target, then click **Next**.
...
1. Review your inputs and select **Migrate**. A new warehouse item is created and the metadata migration begins.
    ...
    Assistant. The source is a DACPAC file and the Destination is a new warehouse item named AdventureWorks.](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image88.png)
...
1. Open the metadata migration summary in full screen view for better readability. Apply filters to view specific object types.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image92.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image93.png)
...
1. Optionally, select the **Export** menu to download a migration summary as an Excel file or a CSV.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image95.png)

1. Select the exported file to review the **CSV** data.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image96.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image97.png)

1. Each exported file provides a structured, comprehensive view of your migration results, including:
...
1. Select a database object that failed to migrate. A new query opens under the **Shared queries** in the **Explorer**. This new query shows the metadata definition and the adjustments that were made to it as automatic comments added to the T-SQL code.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image99.png)

1. Review the comments in the beginning of the script to see the adjustments that were made to the script.

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image100.png)
...
1. The next script to be fixed opens.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image103.png)
...
Copy data helps with migrating data used by the objects you migrate. You can use a [Fabric Data Factory copy job](https://learn.microsoft.com/en-us/fabric/data-factory/create-copy-job) to do it manually, or follow these steps for the copy job integration in the Migration assistant.
...
1. Assign a name to the new job as +++migrate_copyjob+++, then select **Create**.
...
1. Once copy job is complete, check the **3. Copy data** step in the Migration assistant. Select the back button on the top to return the top-level view of the Migration assistant.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image114.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image115.png)
...
1. In Synapse Studio, navigate to the **Develop** hub, click the **+** button to add new resource, then select **SQL script**.
...
1. Enter the following code into the editor and click **Run** to execute it
    ...
    **SQL**
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image118.png)

1. After running the SQL script, the query results are displayed in the table view, showing the application name, login name, and IP address returned by the query

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image119.png)
...
1. Update the connections for data loading (ETL/ELT) platforms to point to your Fabric warehouse.
    ...
    - Use the [List Connections REST API](https://learn.microsoft.com/en-us/rest/api/fabric/core/connections/list-connections?tabs=HTTP) to find connections to your old data source, the Azure Synapse Analytics dedicated SQL pool.
...
1. Once complete, check the **Reroute connections** step in the Migration assistant.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image121.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/mgrtnmsfbrcdepth/refs/heads/main/Cloud%20slice/Labguides/Lab1/media/image122.png)

    >[!Knowledge] A dedicated SQL pool consumes billable resources as long as it's active. Please ensure that you pause the pool even if you are taking a small break from the lab execution. If the pool is in active state for more than 40 minutes and is not being used, your account might get disabled

    >[!Note] Proceed to continue working on Lab 2

### Summary

In this lab, you successfully performed a full migration journey from **Azure Synapse Analytics dedicated SQL pools** to **Microsoft Fabric Data Warehouse**. You began by configuring Azure and Synapse resources, uploading datasets, and creating data pipelines. You then created a Microsoft Fabric workspace and used the **Migration Assistant** to translate and migrate metadata, fix compatibility issues, and copy data into the new warehouse.

Finally, you learned how to reroute external applications-such as Power BI, pipelines, and ETL tools-to the Fabric environment to ensure smooth operational transition. Completion of this lab equips you with essential skills needed for modernizing analytical workloads using Microsoft Fabric.
